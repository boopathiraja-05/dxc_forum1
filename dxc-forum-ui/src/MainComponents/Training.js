                ...
                <tbody>
                  {this.state.trainings.map((training) => (
                    <tr key={training.id}>
                      ...
                      <td> {training.sessionTime}</td>
                      <td className="text-center">
                        {" "}
                        <button
                          className="btn btn-info btn-sm "
                          onClick={() => this.linkButton(training.sessionLink)}
                        >
                          Click Here
                        </button>
                      </td>
                      <td className="text-center">
                        ...
                        <button
                          className="btn btn-info btn-sm"
                          onClick={() => this.linkButton(training.sessionVideo)}
                        >
                          Click Here
                        </button>
                      </td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-content">
                            ...
                            <a onClick={() => this.deleteTraining(training.id)}>
                              Delete
                            </a>
                          </div>
                        </div>
